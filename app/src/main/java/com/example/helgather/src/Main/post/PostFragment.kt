...
class PostFragment : BaseFragment<FragmentPostBinding>(FragmentPostBinding::bind , R.layout.fragment_post) {
    ...
    var postTestList = listOf<PostListResult>(
        PostListResult(1,"노균욱","이것은 제목 테스트 입니다.",12,"2023-05-15 21:08:11"),
        PostListResult(1,"김지홍","이것은 제목 테스트 입니다.",12,"2023-05-15 21:09:11"),
        PostListResult(1,"진주성","이것은 제목 테스트 입니다.",12,"2023-05-15 21:10:11"),
        PostListResult(1,"노균욱","이것은 제목 테스트 입니다.",12,"2023-05-15 21:08:11"),
        PostListResult(1,"김지홍","이것은 제목 테스트 입니다.",12,"2023-05-15 21:09:11"),
        PostListResult(1,"진주성","이것은 제목 테스트 입니다.",12,"2023-05-15 21:10:11"),
        PostListResult(1,"노균욱","이것은 제목 테스트 입니다.",12,"2023-05-15 21:08:11"),
